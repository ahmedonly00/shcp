...
class ConsultationServiceTest {
        ...
        @Mock
        ConsultationAuditEventRepository auditRepository;
        @Mock
        ...
        void getById_shouldThrowForbidden_whenPatientAccessesOtherConsultation() {
                ...
                assertThatThrownBy(() -> consultationService.getById(c.getConsultationId(), otherId, Role.PATIENT))
                                .isInstanceOf(AppException.class)
        ...
        private Appointment buildAppointment(UUID patientId, UUID providerId,
                ...
                User pu = new User();
                pu.setUserId(patientId);
                pu.setName("Patient");
                pu.setEmail("p@test.com");
                ...
                User pvu = new User();
                pvu.setUserId(providerId);
                pvu.setName("Dr Test");
                pvu.setEmail("dr@test.com");
                pvu.setRole(Role.PROVIDER);
                pvu.setVerified(true);
                Provider provider = new Provider();
                provider.setUserId(providerId);
                provider.setUser(pvu);
